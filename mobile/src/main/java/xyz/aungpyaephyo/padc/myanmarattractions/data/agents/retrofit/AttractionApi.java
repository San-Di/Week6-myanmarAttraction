...
public interface AttractionApi {
    ...
    @FormUrlEncoded
    @POST(MyanmarAttractionsConstants.API_GET_ATTRACTION_LIST)//only api name //not root url
    Call<AttractionListResponse> loadAttractions(
            @Field(MyanmarAttractionsConstants.PARAM_ACCESS_TOKEN) String param);//field annotation is used because fromUrlEncoed annotation is used
}
